...
import { getProjectPath, readCanvasJSON, writeCanvasJSON, validateTagRange, formatOutput, makeResult } from '@pixelcreator/core';
import type { AnimationDirection, AnimationTag } from '@pixelcreator/core';
