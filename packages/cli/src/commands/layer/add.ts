...
import { getProjectPath, readCanvasJSON, writeCanvasJSON, ensureCanvasStructure, generateSequentialId, formatOutput, makeResult } from '@pixelcreator/core';
import type { LayerType } from '@pixelcreator/core';
