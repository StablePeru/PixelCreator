...
import { getProjectPath, readCanvasJSON, readLayerFrame, writeLayerFrame, flattenLayers, generatePalette, colorDistance, formatOutput, makeResult } from '@pixelcreator/core';
import type { LayerWithBuffer, RGBA } from '@pixelcreator/core';
