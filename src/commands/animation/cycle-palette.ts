...
import { getProjectPath, readCanvasJSON, writeCanvasJSON, readPaletteJSON, readLayerFrame, writeLayerFrame } from '../../io/project-io.js';
import { flattenLayers } from '../../core/layer-engine.js';
import type { LayerWithBuffer } from '../../core/layer-engine.js';
import { generatePaletteCycleFrames } from '../../core/animation-engine.js';
